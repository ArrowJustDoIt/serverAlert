...
class weChatCore {
     ...
     */
  	...
  	private function getJsApiTicket() {
	    ...
	    $data = json_decode($this->get_php_file("/htdocs/weixin/token/jsapi_ticket.php"));
	    if ($data->expire_time < time()) {
		    ...
		    if ($ticket) {
		        ...
		        $this->set_php_file("/htdocs/weixin/token/jsapi_ticket.php", json_encode($data));
		    }
	    } else {
  	...
  	public function getAccessToken() {
	    ...
	    $data = json_decode($this->get_php_file("/htdocs/weixin/token/access_token.php"));
	    if ($data->expire_time < time()) {
		    ...
		    $access_token = $res->access_token;
	      	if ($access_token) {
		        ...
		        $this->set_php_file("/htdocs/weixin/token/access_token.php", json_encode($data));
	      	}
	    } else {
